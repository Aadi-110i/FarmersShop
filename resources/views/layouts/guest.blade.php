    ...
    <body class="antialiased text-[#2D3A33]">
        ...
        <div class="min-h-screen flex flex-col md:flex-row overflow-hidden">
            ...
            <div class="hidden md:block md:w-1/2 lg:w-3/5 relative overflow-hidden">
                <img src="/images/nature-bg.png" 
                     class="absolute inset-0 w-full h-full object-cover" 
                     alt="Nature Scenery">
                <div class="absolute inset-0 bg-forest/30 backdrop-blur-[2px]"></div>
                
                <div class="absolute inset-0 p-12 flex flex-col justify-between">
                    <a href="/" class="flex items-center gap-2 text-white group">
                        <svg class="w-10 h-10 group-hover:rotate-12 transition-transform" fill="currentColor" viewBox="0 0 24 24"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zm-1-15h2v6h-2V7zm0 8h2v2h-2v-2z" opacity="0.3"/><path d="M11 21.9v-2.1c-4.4-.5-8-4.1-8.5-8.5H.4c.5 5.5 4.9 9.9 10.6 10.6zm2 0c5.7-.7 10.1-5.1 10.6-10.6h-2.1c-.5 4.4-4.1 8-8.5 8.5v2.1zM2.5 11h2.1c.5-4.4 4.1-8 8.5-8.5V.4C7.4 1.1 3 5.5 2.5 11zm19 0c-.5-5.5-4.9-9.9-10.6-10.6v2.1c4.4.5 8 4.1 8.5 8.5h2.1z"/></svg>
                        <span class="font-heading font-bold text-3xl tracking-tight">TerraMarket</span>
                    </a>
                    
                    <div class="max-w-md">
                        <h2 class="text-white font-heading text-5xl leading-tight mb-4">Cultivating Growth in the Community.</h2>
                        <p class="text-sage/80 text-lg">Join the network of farmers and suppliers building a better agricultural future.</p>
                    </div>
                </div>
            </div>
